...
Feature: Outcome Tests
  ...
  Scenario Outline: As a Gateway I can receive an outcome from TM and create Census Events
   ...
   | CE         | Switch Feedback Site      | Irrelavant     | Irrelavant        | 23-20-01     | F            | T                    | SWITCH_FEEDBACK_CE_SITE,UPDATE_RESIDENT_COUNT_0,NEW_UNIT_ADDRESS,FULFILMENT_REQUESTED            | NEW_ADDRESS_REPORTED,FIELD_CASE_UPDATED                                               | NEW_ADDRESS_REPORTED | SWITCH_CE_TYPE |
   | CE         | Switch Feedback Site      | Irrelavant     | Irrelavant        | 23-20-01     | T            | T                    | SWITCH_FEEDBACK_CE_SITE,UPDATE_RESIDENT_COUNT_0,NEW_UNIT_ADDRESS,FULFILMENT_REQUESTED            | NEW_ADDRESS_REPORTED,FIELD_CASE_UPDATED                                               | NEW_ADDRESS_REPORTED | SWITCH_CE_TYPE |
