...
Feature: Outcome Tests
  ...
  Scenario Outline: As a Gateway I can receive an outcome from TM and create Census Events
   ...
   | CE         | Switch Feedback Estab     | Irrelavant     | Irrelavant        | 20-20-08     | F            | T                    | SWITCH_FEEDBACK_CE_EST_F,UPDATE_RESIDENT_COUNT,FULFILMENT_REQUESTED                            | FIELD_CASE_UPDATED                                               | SWITCH_CE_TYPE |
   | CE         | Switch Feedback Estab     | Irrelavant     | Irrelavant        | 20-20-08     | T            | T                    | SWITCH_FEEDBACK_CE_EST_F,UPDATE_RESIDENT_COUNT,FULFILMENT_REQUESTED                            | FIELD_CASE_UPDATED                                               | SWITCH_CE_TYPE |
   ...
   | CE         | Switch Feedback Unit      | Irrelavant     | Irrelavant        | 24-30-04     | F            | T                    | SWITCH_FEEDBACK_CE_UNIT_F,FULFILMENT_REQUESTED                                                 |                                                                  | SWITCH_CE_TYPE    |
   | CE         | Switch Feedback Unit      | Irrelavant     | Irrelavant        | 24-30-04     | T            | T                    | SWITCH_FEEDBACK_CE_UNIT_F,FULFILMENT_REQUESTED                                                 |                                                                  | SWITCH_CE_TYPE    |
