...
@SelectClasspathResource("acceptancetests/OutcomesHardRefusal.feature")
...
@ConfigurationParameter(key = PLUGIN_PROPERTY_NAME, value = "pretty,json:target/jsonReports/cucumber-outcomes-hard-refusal.json")
