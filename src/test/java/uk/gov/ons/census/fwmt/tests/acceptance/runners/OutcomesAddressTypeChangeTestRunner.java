...
@SelectClasspathResource("acceptancetests/OutcomesAddressTypeChange.feature")
...
@ConfigurationParameter(key = PLUGIN_PROPERTY_NAME, value = "pretty,json:target/jsonReports/cucumber-outcomes-address-type.json")
