...
Feature: Outcome Address Type Change Tests
  ...
  Scenario Outline: As a Gateway I can receive an outcome from TM and create Census Events
    ...
    Examples:
      ...
      | SPG        | Address Type Changed HH  | Not Valid       | Phone - Property is a household | 6-10-03      | F            | T                    | ADDRESS_TYPE_CHANGED_HH,FULFILMENT_REQUESTED             | ADDRESS_TYPE_CHANGED                                           | ADDRESS_TYPE_CHANGED |            |
      | SPG        | Address Type Changed HH  | Not Valid       | Phone - Property is a household | 6-10-03      | T            | T                    | ADDRESS_TYPE_CHANGED_HH,FULFILMENT_REQUESTED             | ADDRESS_TYPE_CHANGED                                           | ADDRESS_TYPE_CHANGED |            |
      ...
      | SPG        | Address Type Changed CE  | Not Valid       | Phone - Property is a CE        | 6-10-01      | F            | T                    | ADDRESS_TYPE_CHANGED_CE_EST,FULFILMENT_REQUESTED          | ADDRESS_TYPE_CHANGED                                           | ADDRESS_TYPE_CHANGED |            |
      | SPG        | Address Type Changed CE  | Not Valid       | Phone - Property is a CE        | 6-10-01      | T            | T                    | ADDRESS_TYPE_CHANGED_CE_EST,FULFILMENT_REQUESTED          | ADDRESS_TYPE_CHANGED                                           | ADDRESS_TYPE_CHANGED |            |
      ...
      | CE         | Address Type Changed HH  | Not Valid       | Phone - Property is a household | 20-10-01     | F            | T                    | ADDRESS_TYPE_CHANGED_HH,FULFILMENT_REQUESTED             | ADDRESS_TYPE_CHANGED                                           | ADDRESS_TYPE_CHANGED |            |
      | CE         | Address Type Changed HH  | Not Valid       | Phone - Property is a household | 20-10-01     | T            | T                    | ADDRESS_TYPE_CHANGED_HH,FULFILMENT_REQUESTED             | ADDRESS_TYPE_CHANGED                                           | ADDRESS_TYPE_CHANGED |            |
      ...
      | CE         | Address Type Changed SPG | Not Valid       | Phone - Property is a CE        | 20-10-03     | F            | T                    | ADDRESS_TYPE_CHANGED_SPG,FULFILMENT_REQUESTED            | ADDRESS_TYPE_CHANGED                                           | ADDRESS_TYPE_CHANGED |            |
      | CE         | Address Type Changed SPG | Not Valid       | Phone - Property is a CE        | 20-10-03     | T            | T                    | ADDRESS_TYPE_CHANGED_SPG,FULFILMENT_REQUESTED            | ADDRESS_TYPE_CHANGED                                           | ADDRESS_TYPE_CHANGED |            |
