  ...
  Scenario Outline: As a Gateway I can receive an outcome from TM and create Census Events
   ...
   Examples:
     | SurveyType | BusinessFunction | Primary Outcome | Secondary Outcome | Outcome Code | HasLinkedQID | HasFulfilmentRequest | Operation List | RmMessages | JsMessages |
      ...
      | SPG | No Action | Irrelevant | Irrelevant | 6-20-02 | F | F | NO_ACTION,FULFILMENT_REQUESTED,LINKED_QID |  |  |
      | SPG | No Action | Irrelevant | Irrelevant | 6-20-02 | T | F | NO_ACTION,FULFILMENT_REQUESTED,LINKED_QID | QUESTIONNAIRE_LINKED |  |
      | SPG | No Action | Irrelevant | Irrelevant | 6-20-02 | F | T | NO_ACTION,FULFILMENT_REQUESTED,LINKED_QID | FULFILMENT_REQUESTED |  |
      | SPG | No Action | Irrelevant | Irrelevant | 6-20-02 | T | T | NO_ACTION,FULFILMENT_REQUESTED,LINKED_QID | FULFILMENT_REQUESTED,QUESTIONNAIRE_LINKED |  |
     ...
     | CE | Update Resident Count | Contact Made | Visit agreed to deliver | 20-20-01 | T | T | UPDATE_RESIDENT_COUNT,FULFILMENT_REQUESTED,LINKED_QID | FIELD_CASE_UPDATED,FULFILMENT_REQUESTED,QUESTIONNAIRE_LINKED |  |
      ...
      | CE | No Action | Irrelevant | Irrelevant | 25-30-02 | F | F | NO_ACTION,FULFILMENT_REQUESTED,LINKED_QID |  |  |
      | CE | No Action | Irrelevant | Irrelevant | 25-30-02 | T | F | NO_ACTION,FULFILMENT_REQUESTED,LINKED_QID | QUESTIONNAIRE_LINKED |  |
      | CE | No Action | Irrelevant | Irrelevant | 25-30-02 | F | T | NO_ACTION,FULFILMENT_REQUESTED,LINKED_QID | FULFILMENT_REQUESTED |  |

      | CE | No Action | Irrelevant | Irrelevant | 25-30-02 | T | T | NO_ACTION,FULFILMENT_REQUESTED,LINKED_QID | FULFILMENT_REQUESTED,QUESTIONNAIRE_LINKED |  |
      ...
      | HH | No Action | Irrelevant | Irrelevant | 01-01-04 | F | F | NO_ACTION,LINKED_QID |  |  |
      | HH | No Action | Irrelevant | Irrelevant | 01-01-04 | T | F | NO_ACTION,LINKED_QID | QUESTIONNAIRE_LINKED |  |
