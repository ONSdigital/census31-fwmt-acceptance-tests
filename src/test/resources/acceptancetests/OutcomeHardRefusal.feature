...
Feature: Outcome Hard Refusal Tests
  ...
  Scenario Outline: As a Gateway I can receive a hard refusal outcome from TM and create Census Events
    ...
    Examples:
      ...
      | HH         | Hard Refusal             | Contact Made    | Visit - Hard refusal     | 21-20-14     | T            | F                    | HARD_REFUSAL_RECEIVED                                                 | REFUSAL_RECEIVED,QUESTIONNAIRE_LINKED | CANCEL     |
      ...
      | CE         | Hard Refusal             | Contact Made    | Phone - Hard Refusal     | 20-20-04     | F            | T                    | HARD_REFUSAL_RECEIVED,CANCEL_FEEDBACK,FULFILMENT_REQUESTED            | REFUSAL_RECEIVED                   | CANCEL     |
      | CE         | Hard Refusal             | Contact Made    | Phone - Hard Refusal     | 20-20-04     | T            | T                    | HARD_REFUSAL_RECEIVED,CANCEL_FEEDBACK,FULFILMENT_REQUESTED            | REFUSAL_RECEIVED                   | CANCEL     |
      ...
      | SPG        | Hard Refusal             | Contact Made    | Phone - Hard Refusal     | 6-20-04      | F            | T                    | HARD_REFUSAL_RECEIVED,CANCEL_FEEDBACK,FULFILMENT_REQUESTED            | REFUSAL_RECEIVED                   | CANCEL     |
      | SPG        | Hard Refusal             | Contact Made    | Phone - Hard Refusal     | 6-20-04      | T            | T                    | HARD_REFUSAL_RECEIVED,CANCEL_FEEDBACK,FULFILMENT_REQUESTED            | REFUSAL_RECEIVED                   | CANCEL     |
